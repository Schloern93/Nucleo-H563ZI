...
void SystemCoreClockUpdate(void) {
  ...
  case 0x08UL: /* CSI used as system clock  source */ SystemCoreClock = CSI_VALUE; break;

  case 0x10UL: /* HSE used as system clock  source */ SystemCoreClock = HSE_VALUE; break;
  ...
  case 0x18UL: /* PLL1 used as system clock source */
    ...
    */
    ...
    default: /* No clock sent to PLL*/ pllvco = (float_t)0U; break;
    }
